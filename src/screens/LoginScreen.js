...
export default function LoginScreen() {
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                window.location.replace('http://localhost:3000/HomeScreen');
            } else {
    ...
    return (
        <form>
            <div style={{ fontSize: "25px", padding: "2%", paddingLeft: "4%", paddingTop: "4%" }}>{loginMode ? "Login" : "Signup"}:</div>
            ...
            <div style={{ fontSize: "25px", padding: "2%", paddingLeft: "4%" }}>Password:</div>
            <div style={{ margin: "3%", marginTop: "0", padding: "2%" }}>
            ...
            <div style={{ marginLeft: "40%", marginRight: "40%", marginBottom: "8%", marginTop: "0%", padding: "2%", textAlign: "center" }}>
                <button type="submit" style={{ fontSize: "25px", backgroundColor: "white" }} onClick={handleOnSubmit}>
                    {loginMode ? "Login" : "Signup"}
                </button>
            </div>
            <div style={{ textAlign: "center" }}>
        <span onClick={() => setLoginMode(!loginMode)} style={{ cursor: "pointer", color: "blue", textDecoration: "underline" }}>
